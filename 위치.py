...
###########################################################################로그 출력되는 부분####################################################################
                        if x_center is not None and y_center is not None:
                            if text_to_speech(f"{names[int(c)]}"):
...
def parse_opt():
    ...
    # 경로
    parser.add_argument("--source", type=str, default=ROOT / "C:/Users/AIA/yolov5/data/images/demo.mp4", help="file/dir/URL/glob/screen/0(webcam)")
